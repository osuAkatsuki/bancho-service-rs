...
pub async fn fetch_friends<C: Context>(ctx: &C, user_id: i64) -> anyhow::Result<Vec<Relationship>> {
...
pub async fn add_friend<C: Context>(ctx: &C, user_id: i64, to_add: i64) -> anyhow::Result<()> {
...
pub async fn remove_friend<C: Context>(
    ctx: &C,
    user_id: i64,
    to_remove: i64,
) -> anyhow::Result<()> {
